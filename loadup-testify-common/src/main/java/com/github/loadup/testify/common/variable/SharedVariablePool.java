...
/**
 * Thread-safe shared variable pool for storing and retrieving variables across test cases. Supports
 * automatic capture of Datafaker-generated values and cross-file references.
 */
public class SharedVariablePool {
  ...
  public static Map<String, Object> getAll() {
    return new java.util.HashMap<>(THREAD_LOCAL_POOL.get());
  }
