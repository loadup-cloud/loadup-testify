...
public class PrepareData {
  ...
  @Builder.Default private boolean loaded = false;

  /** Error message if loading failed. */
  private String errorMessage;

  /**
   * Captured variables for this test case. Used to reference Datafaker-generated values across
   * PrepareData and ExpectedData.
   */
  @Builder.Default private Map<String, Object> capturedVariables = new ConcurrentHashMap<>();
}
