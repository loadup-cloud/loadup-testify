...
public class TestCaseConfig {
  ...
  /**
   * Arguments to pass to the test method. Can be a list of objects that will be mapped to method
   * parameters.
   */
  ...
  /** Expected database state assertions. Map of table name to expected rows. */
  ...
  @Builder.Default private boolean ignoreOrder = false;
  ...
  /** Max duration for the test (ms). */
  private Long maxDuration;

  /** Minimum throughput (requests per second) required. */
