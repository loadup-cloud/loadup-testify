...
public class OrderService {
  ...
  public Order createOrder(Order order) {
    ...
    String sql =
        "INSERT INTO orders (user_id, order_number, total_amount, status, extra_info, created_at, updated_at) "
            + "VALUES (?, ?, ?, ?, ?, ?, ?)";
  ...
  /**
   * Create an order with extra info JSON field. Demonstrates JSON String field handling.
   *
