...
public class UserService {
  ...
  public User createUser(User user) {
    ...
    String sql =
        "INSERT INTO users (username, email, first_name, last_name, age, active) "
            + "VALUES (?, ?, ?, ?, ?, ?)";
  ...
  /**
   * Create a new user with a role. Demonstrates multiple parameter handling and nested object
   * mapping.
   *
   * @param user the user to create
