...
/**
 * Example test class demonstrating Testify data-driven testing for
 * OrderService.
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>JSON field comparison</b> - The extraInfo field contains JSON data
 * that is compared
 * semantically (ignoring key order and whitespace)
 * <li><b>DateTime tolerance</b> - The createdAt/updatedAt fields support
 * tolerance comparison for
 * time differences
 * <li><b>Complex parameter handling</b> - Multiple parameters with different
 * types
 * </ul>
 *
 * <p>
...
public class OrderServiceTest extends TestifyTestBase {
  ...
  /**
   * The service under test. The service name "OrderService" is derived from this
   * field's type
   ...
   *
   * <p>
   * Method name "testCreateOrder" → "createOrder"
   *
   * <p>
   * Test data is loaded from: OrderService.createOrder/case01/
   */
  @TestifyTest
  ...
  /**
   * Test creating an order with extra info JSON field. Demonstrates JSON String
   * field handling for
   * large objects.
   *
   * <p>
   * Method name "testCreateOrderWithExtraInfo" → "createOrderWithExtraInfo"
   *
   * <p>
   * Test data is loaded from: OrderService.createOrderWithExtraInfo/case01/
   */
  @TestifyTest
  ...
  /**
   * Create an order with extra info - demonstrates JSON field and multiple
   * parameters.
   *
   ...
   */
  public Order createOrderWithExtraInfo(
      Long userId, String orderNumber, BigDecimal totalAmount, String extraInfo) {
