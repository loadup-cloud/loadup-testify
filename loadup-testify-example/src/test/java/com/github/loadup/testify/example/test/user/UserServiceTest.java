package com.github.loadup.testify.example.test.user;
...
import com.github.loadup.testify.example.service.RoleService;
import com.github.loadup.testify.example.service.UserService;
 ...
 *
 * <ol>
 * <li>Use the @TestBean annotation to mark the service under test
 * <li>Use the TestifyProvider for data-driven tests
 * <li>Prepare database data from multiple CSV files
 * <li>Execute test methods with complex parameters
 * <li>Assert database state after test execution
 * <li>Use Datafaker for random data generation
 * <li>Reference captured variables across test phases
 * <li>Mock external dependencies using Mockito
 * <li>Test methods with multiple parameters
 * <li>Test nested complex objects (User with Role)
 * </ol>
 */
...
public class UserServiceTest extends TestifyTestBase {
  ...
  /**
   * The service under test. The service name "UserService" is derived from this
   * field's type
   * and implicit detection.
   */
  @Autowired
  ...
  protected void beforeTestMethod() {
    ...
    Role mockRole = Role.builder().id(1L).name("USER").description("Default user role").active(true).build();
   ...
   *
   * <p>
   * Method name "testCreateUser" → "createUser"
   *
   * <p>
   * Test data is loaded from: UserService.createUser/case01/
   */
  @TestifyTest
  ...
  /**
   * Test creating a user with role - demonstrates multiple parameters and
   * mocking.
   *
   * <p>
   * Method name "testCreateUserWithRole" → "createUserWithRole"
   *
   * <p>
   * Test data is loaded from: UserService.createUserWithRole/case01/
   *
   * <p>
