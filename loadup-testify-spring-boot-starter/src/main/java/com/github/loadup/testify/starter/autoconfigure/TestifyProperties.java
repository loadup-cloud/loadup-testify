...
/**
 * Configuration properties for LoadUp Testify. These properties can be set in
...
public class TestifyProperties {
  ...
  /**
   * Base path for test data files (relative to classpath). If not set, uses the test class package
   * path.
   */
