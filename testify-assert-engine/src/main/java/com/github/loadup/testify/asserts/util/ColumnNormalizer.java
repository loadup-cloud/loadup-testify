...
/**
 * Utility for normalizing database column names to support case-insensitive
 * and underscore/camelCase matching.
 */
public class ColumnNormalizer {

    /**
     * Normalize a map of database results to use case-insensitive keys.
