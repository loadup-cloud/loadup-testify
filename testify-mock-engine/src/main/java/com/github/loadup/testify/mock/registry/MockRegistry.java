...
/**
 * Thread-local registry for tracking mocked beans during test execution. Ensures mocks are properly
 * isolated between test cases.
 */
public class MockRegistry {

  private static final ThreadLocal<Map<String, Object>> MOCKED_BEANS =
  ...
  /**
   * Clear all mocks for the current thread. Should be called in @AfterMethod to prevent cross-test
   * pollution.
   */
